...
export const translations = {
    tr: {
        ...
        cookie_desc: "Size en iyi kullanıcı deneyimini sunabilmek ve web sitesi trafiğini analiz etmek için çerezleri kullanıyoruz. Sitemizi kullanmaya devam ederek çerez kullanımını kabul etmiş olursunuz.",
        cookie_accept: "Kabul Et",
        cookie_learn_more: "Çerez Politikası",
        market_rates_title: "Piyasa Referans Oranları",
        rate_inflation: "Ortalama Enflasyon",
        rate_savings: "Mevduat / Faiz Getirisi",
        rate_stocks: "Borsa Ortalama Getirisi",
        adblock_title: "Reklam Engelleyici Tespit Edildi",
        adblock_desc: "Lütfen sitemizi beyaz listeye (whitelist) ekleyerek bu ücretsiz finansal araçları desteklemeye devam edin. Teşekkür ederiz!",
    ...
    en: {
        ...
        cookie_title: "Privacy & Cookies",
        cookie_desc: "We use cookies to enhance your browsing experience and analyze site traffic. By continuing to visit this site, you agree to our use of cookies.",
        cookie_accept: "Accept",
        cookie_learn_more: "Privacy Policy",
        market_rates_title: "Market Reference Rates",
        rate_inflation: "Typical Inflation",
        rate_savings: "HYSA / Deposit Yield",
        rate_stocks: "Avg Stock Return",
        adblock_title: "Ad-Blocker Detected",
        adblock_desc: "Please whitelist our site to help keep these financial calculation tools free. Thank you for your support!",
        nav_admin: "⚙️ Admin Dashboard",
